...
const TextareaWithPlaceholder = ({ value, onChange, placeholderContent, heightClass = "h-48" }) => {
  ...
  return (
    <div className="relative z-10 w-full">
      <textarea
        ...
        className={`${heightClass} form-text-area z-20 ${showPlaceholder ? "bg-transparent" : "bg-white" }`}>
      </textarea>
