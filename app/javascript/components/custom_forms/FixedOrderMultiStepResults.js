...
import FragmentRefreshButton from '../listings_builder/FragmentRefreshButton';
import FragmentResult from '../listings_builder/FragmentResult';
import CopyButton from '../common/CopyButton';
import LanguageToggle from '../common/LanguageToggle';

const english = "EN";

const Results = ({ runsRemaining, results, onRerun, loading, setLoading, formType }) => {
