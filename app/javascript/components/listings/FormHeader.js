  ...
  return (
    <div className="flex flex-col items-center w-full border-r-2 md:w-1/2">
      <div className="p-4 w-full tracking-wide text-center text-gray-800 bg-grey-50">
        <div class="py-3 px-4 text-left rounded-b border-l-4 shadow border-t-1" role="alert">
          <div class="flex">
            <div class="py-1">
              <svg class="mr-4 w-6 h-6 text-teal-500 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
