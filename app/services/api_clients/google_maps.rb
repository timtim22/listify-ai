module ApiClients
  class GoogleMaps
    ...
    NEARBY_URL    = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?'.freeze
    DISTANCE_URL  = 'https://maps.googleapis.com/maps/api/distancematrix/json?'.freeze
    REQUEST_CAP   = 12
