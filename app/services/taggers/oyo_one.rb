  ...
  class OyoOne
    ...
    class << self
      ...
      def tags_for(attrs)
        ...
        tags << property_tag(attrs[:property_type])
        tags << location_detail_tags(attrs[:location_detail])
        tags << target_user_tags(attrs[:target_user])
        tags << usp_tags(attrs[:usp_one])
        tags << usp_tags(attrs[:usp_two])
        tags << usp_tags(attrs[:usp_three])
