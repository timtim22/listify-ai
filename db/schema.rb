...
ActiveRecord::Schema.define(version: 2022_11_10_160055) do
  ...
  create_table "charges", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "invoice_amount_excluding_tax"
    t.integer "invoice_amount_tax"
  ...
  create_table "custom_inputs_oyo_threes", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "request_type"
    t.text "input_text"
    t.string "usp_one"
    t.string "usp_two"
  ...
  create_table "custom_inputs_oyo_twos", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "request_type"
    t.text "input_text"
    t.string "usp_one"
    t.string "usp_two"
  ...
  create_table "custom_inputs_sykes_middles", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "request_type"
    t.text "input_text"
    t.text "key_features"
    t.string "tags", default: [], array: true
  ...
  create_table "custom_inputs_vacasa_ones", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "request_type"
    t.text "input_text"
    t.text "key_features"
    t.string "tags", default: [], array: true
  ...
  create_table "custom_inputs_vacasa_threes", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "request_type"
    t.text "input_text"
  ...
  create_table "custom_inputs_vacasa_twos", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "request_type"
    t.text "input_text"
  ...
  create_table "users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.boolean "private_beta_account", default: false
    t.datetime "custom_trial_end_date"
